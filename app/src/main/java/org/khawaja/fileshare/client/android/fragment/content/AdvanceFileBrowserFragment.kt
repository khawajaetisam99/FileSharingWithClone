...
import org.khawaja.fileshare.client.android.viewmodel.AdvanceFilesViewModel
...
@AndroidEntryPoint
class AdvanceFileBrowserFragment : Fragment(R.layout.layout_file_browser) {
    ...
    private val viewModel: AdvanceFilesViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val pathAdapter = AdvancePathAdapter {
...
class AdvancePathContentViewModel(fileModel: FileModel) {
...
class AdvanceFilePathViewHolder constructor(
    private val clickListener: (FileModel) -> Unit,
    private var binding: AdvanceListPathBinding,
) : RecyclerView.ViewHolder(binding.root) {
    fun bind(fileModel: FileModel) {
        binding.viewModel = AdvancePathContentViewModel(fileModel)
...
class AdvancePathAdapter(
    private val clickListener: (FileModel) -> Unit,
) : ListAdapter<FileModel, AdvanceFilePathViewHolder>(AdvanceFileModelItemCallback()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdvanceFilePathViewHolder {
        return AdvanceFilePathViewHolder(
            clickListener,
            AdvanceListPathBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }

    override fun onBindViewHolder(holder: AdvanceFilePathViewHolder, position: Int) {
...
class AdvanceFileModelItemCallback : DiffUtil.ItemCallback<FileModel>() {
