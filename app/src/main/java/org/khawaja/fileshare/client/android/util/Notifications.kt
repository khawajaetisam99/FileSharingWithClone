...
import org.khawaja.fileshare.client.android.receiver.BgBroadcastReceiver
import org.khawaja.fileshare.client.android.receiver.BgBroadcastReceiver.Companion.ACTION_STOP_ALL_TASKS
import org.khawaja.fileshare.client.android.service.BackgroundService
import org.khawaja.fileshare.client.android.service.BackgroundService.Companion.ACTION_STOP_ALL
...
class Notifications(val backend: NotificationBackend) {
    ...
    fun notifyTransferError() {
        // TODO: 12/12/21 Show transfer errors when the user is showing a related section.
    }
