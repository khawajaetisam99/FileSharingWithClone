...
import org.khawaja.fileshare.client.android.databinding.LayoutPrepareSharingBinding
        ...
        preparationViewModel.shared.observe(viewLifecycleOwner) {
            when (it) {
                is PreparationState.Progress -> {
                    ...
                    //binding.progressBar.progressBackgroundTintList = ColorStateList.valueOf(Color.RED)
