...
import org.khawaja.fileshare.client.android.databinding.ListTransferBinding
...
import org.khawaja.fileshare.client.android.viewmodel.content.TransferStateFeederViewModel

class TransportDetailsIncomingViewHolder(
    ...
    // FIXME: 12/12/21 ViewHolder lifecycle isn't called when user leaves the activity
    ...
    fun onDestroy() {
        // FIXME: 12/12/21 Recycled views are still being used for some reason and destroyed state is not reusable
    ...
    fun bind(transferDetail: TransferDetail) {
        ...
        binding.feederModel =
            TransferStateFeederViewModel(gibSubscriberListener(transferDetail))
