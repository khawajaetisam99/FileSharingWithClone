...
import org.khawaja.fileshare.client.android.util.*
...
class BackgroundService : LifecycleService() {
    ...
    companion object {
        const val ACTION_STOP_ALL = "org.khawaja.fileshare.client.android.action.STOP_ALL"

        const val ACTION_STOP_BG_SERVICE = "org.khawaja.fileshare.client.android.action.STOP_BG_SERVICE"
    }
}