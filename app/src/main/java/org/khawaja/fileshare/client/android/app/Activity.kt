...
package org.khawaja.fileshare.client.android.app
...
import org.khawaja.fileshare.client.android.activity.WelcomeActivity
...
abstract class Activity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    private fun requestRequiredPermissions(finishOtherwise: Boolean, results: Map<String, Boolean>? = null) {
        ...
        for (permission in Permissions.getAll()) {
            ...
            val request = {
                ...
                //requestPermissions( this@Activiy, arrayOf(permission.id))

                //requestPermissions(this, new String[]{WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
            }
    ...
    companion object {
        private const val TAG = "Activity (khawaja)"
