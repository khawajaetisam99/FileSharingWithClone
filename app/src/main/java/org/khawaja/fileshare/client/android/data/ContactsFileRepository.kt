...
@Singleton
class ContactsFileRepository @Inject constructor(
    ...
    val defaultAppDirectory:  File by lazy {
        ...
        var primaryDir = File(Environment.getExternalStorageDirectory(), "offlinecontactsglobal")
        ...
        /*if (!primaryDir.isDirectory && !primaryDir .mkdir() || !primaryDir.canWrite() ){
            primaryDir  = File(Environment.getExternalStorageDirectory(), "offlinecontactsglobal")
        }*/
