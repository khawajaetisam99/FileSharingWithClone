package org.khawaja.fileshare.client.android.backend
...
import org.khawaja.fileshare.client.android.di.WebShareServer
import org.khawaja.fileshare.client.android.util.HotspotManager
...
class Services @Inject constructor(
    ...
    private inner class SecondaryHotspotCallback : WifiManager.LocalOnlyHotspotCallback() {
        override fun onStarted(reservation: WifiManager.LocalOnlyHotspotReservation) {
            ...
            context.sendBroadcast(Intent(ACTION_OREO_HOTSPOT_STARTED).putExtra(EXTRA_HOTSPOT_CONFIG, reservation.wifiConfiguration))
        }
    }
    ...
    companion object {
        ...
        const val ACTION_OREO_HOTSPOT_STARTED = "org.khawaja.trebleshot.intent.action.HOTSPOT_STARTED"
