package org.khawaja.fileshare.client.android.protocol
...
import org.khawaja.fileshare.client.android.backend.TransportRegistry
...
import org.khawaja.fileshare.client.android.task.transfer.IndexingParams
...
class MainTransportSeat @Inject constructor(
    ...
    override fun handleFileTransferRequest(
        ...
        check(client is UClient) { "Expected the UClient implementation" }

        val storageLocation = fileRepository.appDirectory.originalUri.toString()
        val transfer = Transfer(groupId, client.clientUid, Incoming,false, storageLocation, accepted = hasPin)
