...
import org.khawaja.fileshare.client.android.databinding.ListAlbumBinding
import org.khawaja.fileshare.client.android.databinding.ListArtistBinding
...
class AudioBrowserViewModel @Inject internal constructor(
    ...
    // get all pdf files with
    /*fun showAllPdfs() {
        viewModelScope.launch(Dispatchers.IO) {
            _showingContent.postValue(Content.AllSongs(filterSongs(mediaRepository.getPDFList())))
        }
    }*/
    ...
    sealed class Content(val type: Type, val isList: Boolean = false, val isFiltered: Boolean = false) {
        ...
        //class AllPdfs(val list: List<Song>)
