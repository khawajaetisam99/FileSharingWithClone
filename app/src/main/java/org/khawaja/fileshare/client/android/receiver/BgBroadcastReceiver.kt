package org.khawaja.fileshare.client.android.receiver
...
class BgBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_CLIPBOARD_COPY = "org.khawaja.fileshare.client.android.action.CLIPBOARD_COPY"

        const val ACTION_DEVICE_KEY_CHANGE_APPROVAL = "org.khawaja.fileshare.client.android.action.DEVICE_APPROVAL"

        const val ACTION_FILE_TRANSFER = "org.khawaja.fileshare.client.android.action.FILE_TRANSFER"

        const val ACTION_PIN_USED = "org.khawaja.fileshare.client.android.transaction.action.PIN_USED"

        const val ACTION_STOP_ALL_TASKS = "org.khawaja.fileshare.client.android.transaction.action.STOP_ALL_TASKS"
