 ...
 */
class OutgoingListContainer : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = TransferHistoryAdapterOutgoing(gibSubscriberListener) {
            when (it) {
                is TransferHistoryAdapterOutgoing.Click.Local -> {
                ...
                is TransferHistoryAdapterOutgoing.Click.Text -> findNavController().navigate(
                    TransferHistoryFragmentDirections.actionTransferHistoryFragmentToNavTextEditor(
                        sharedText = it.text
                    )
                )
                is TransferHistoryAdapterOutgoing.Click.Web -> findNavController().navigate(
        ...
        viewModel.transfersOutgoing.observe(viewLifecycleOwner) {
...
class TransferHistoryAdapterOutgoing(
...
) : ListAdapter<ListItem, RecyclerView.ViewHolder>(TransfersItemCallbackOutgoing()), Filterable {
...
class TransfersItemCallbackOutgoing : DiffUtil.ItemCallback<ListItem>() {
